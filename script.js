...
const translations = {
  hu: {
    ...
    bookingSubtitle: "",
    welcomeTitle: "ÜDVÖZÖLJÜK A DIAMOND LOGISTICSNÉL",
    about_title: "RÓLUNK",
    ...
    contactEmail: "📧 info@diamondlogistics.eu",
    socialTitle: "KÖVESS MINKET",
    footerBottom: "© 2025 DIAMOND LOGISTICS KFT. MINDEN JOG FENNTARTVA.",
  ...
  en: {
    ...
    bookingSubtitle: "",
    welcomeTitle: "WELCOME TO DIAMOND LOGISTICS",
    ...
    footerBottom: "© DIAMOND LOGISTICS KFT. ALL RIGHTS RESERVED.",
